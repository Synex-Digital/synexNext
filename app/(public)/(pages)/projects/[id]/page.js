                    ...
                    <div className="sm:flex justify-between mt-10">
                        <div className=" text-white pb-20 sm:w-[68%]">
                            ...
                            <p className=" font-light">
                                ...
                                advancement organization Internationally
                                conveying the best web improvement
                                administrations to create custom sites, web
                                applications, web-instruments, and so on to
                                worldwide organizations and new businesses with
                                100 percent project conveyance.
                            </p>
                            ...
                            <p className="font-light">
                                ...
                                organization has represented considerable
                                authority in making staggered undertaking-grade
                                web answers to meet different corporate
                                necessities. We foster customized endeavor
                                online interfaces, eCommerce arrangements, B2B
                                and B2C applications, ERP and CRM programming
                                applications, Reporting, Billing & Secure
                                Financial Transaction Processing Systems, and so
                                forth Our undertaking IT and web arrangements
                                are fabricated utilizing the most recent web
                                innovations and they are secure, strong and
                                adaptable which assist organizations with
                                decreasing generally functional expense and
                                upgrade functional productivity.
                            </p>
