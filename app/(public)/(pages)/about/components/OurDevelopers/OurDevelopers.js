        ...
        <div className="container mx-auto px-2">
          ...
          <div className="flex flex-wrap justify-center gap-6 sm:gap-7 mt-20">
            {developersList?.map(({id, name, dp, linkedin, github}) => (
              <div key={id} className="group w-[42%] sm:w-[23%] py-7 text-center text-white rounded-xl cursor-pointer duration-500 hover:shadow-devHover hover:bg-slate-600 hover:text-[#c2e812] hover:border-0">
                <Image
                  className="w-20 sm:w-36 h-20 sm:h-36 mx-auto rounded-[50%] object-cover duration-1000 group-hover:rounded-md sm:group-hover:rounded-xl group-hover:border-0 group-hover:scale-205 sm:group-hover:scale-190"
                  alt="Developer picture"
                  src={aboutimg}
                  width={500}
                  height={500}
                />
                <div className="font-medium text-xl mt-3 duration-200">
                  {name}
                </div>
                <p className="duration-200">Founder & CEO</p>
